...
- [How To Use String Formatters ](https://intranet.alxswe.com/rltoken/ZdtRIAkFu8dMBT99DcFBNg)
...
- Each team should put their source code in the folder containint their programing language eg. python developers should be in a python folder.
...
- create the function to randomly generate integers from 1 to 9999
...
- GitHub repository: `https://github.com/MATRIX30/Git_training.git`
